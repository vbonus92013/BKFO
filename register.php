      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12">
        <div class="row">
          <div class="input-field col s12 center">
            <h4>Đăng kí</h4>
            <p class="center">Gia nhập ngay!</p>
          </div>
        </div>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="name" class="center-align">Họ Tên</label>
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Đã có tài khoản? <a href="login.php">Đăng nhập</a></p>
          </div>
        </div>
      </form>
    </div>
