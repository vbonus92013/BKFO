  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Đặt món</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Phản hồi</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Phản hồi</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Nếu bạn gặp bất cứ vấn đề gì, hãy phản hồi cho chúng tôi.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Mở phản hồi</h4>
              </div>
<div>
                      ...
                      <div class="row">
                        <div class="input-field col s4">
							<select name="type">
								...
								<option value="Complaint">Góp ý</option>
								<option value="Others">Vấn đề khác</option>				
							</select>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">Danh sách phản hồi của bạn</p>
          <div class="divider"></div>
