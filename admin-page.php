      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>-->
				...
				{
					echo '<tr><td><div class="input-field col s12"><label for="'.$row["id"].'_name">Tên</label>';
					...
					echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_price">Giá tiền</label>';
					...
					echo '<select name="'.$row['id'].'_hide">
                      <option value="1"'.$text1.'>Có sẵn</option>
                      <option value="2"'.$text2.'>Không có sẵn</option>
                    </select></td></tr>';
				}
				?>
                    </tbody>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Thêm món ăn</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Giá tiền/Món</th>
                      </tr>
                    </thead>

                    <tbody>
				<?php
					echo '<tr><td><div class="input-field col s12"><label for="name">Tên</label>';
					echo '<input id="name" name="name" type="text" data-error=".errorTxt01"><div class="errorTxt01"></div></td>';					
					echo '<td><div class="input-field col s12 "><label for="price" class="">Giá tiền</label>';
