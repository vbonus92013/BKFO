    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Đặt món</a>
            </li>
                <li class="no-padding">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Phản hồi</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.php">Tất cả</a>
                                </li>
								<?php
            ...
            <li class="bold"><a href="details.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Chỉnh sửa</a>
            </li>				
        </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Chi tiết đơn đặt hàng</h5>
              </div>
            </div>
          </div>
        </div>
...
<?php
    echo '<li class="collection-item avatar">
		...
		<p><strong>Số điện thoại:</strong> '.$contact.'</p>
		<p><strong>Địa chỉ:</strong> '.htmlspecialchars($_POST['address']).'</p>	
		<p><strong>Phương thức thanh toán:</strong> '.$_POST['payment_type'].'</p>			
		...
		<div class="row">
			<div class="collection">
				<a href="#" class="collection-item">
					<div class="row"><div class="col s7">Số dư</div><div class="col s3">'.$balance.'</div></div>
				</a>
				<a href="#" class="collection-item active">
					<div class="row"><div class="col s7">Sô dư sau khi đặt mua</div><div class="col s3">'.($balance-$total).'</div></div>
				</a>
			</div>
		</div>
	</div>';
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Xác nhận
