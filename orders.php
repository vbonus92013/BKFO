  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Danh sách chi tiết các đơn đặt hàng của bạn.</p>
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              ...
                              <p><strong>Phương thức thanh toán:</strong> '.$row['payment_type'].'</p>
							  <p><strong>Địa chỉ: </strong>'.$row['address'].'</p>							  
                              <p><strong>Trạng thái:</strong> '.($status=='Paused' ? 'Paused <a  data-position="bottom" data-delay="50" data-tooltip="Làm ơn liên lạc với Admin để biết thêm chi tiết" class="btn-floating waves-effect waves-light tooltipped cyan">    ?</a>' : $status).'</p>							  
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<input type="hidden" value="Hủy bởi khách hàng" name="status">	
										<input type="hidden" value="'.$row['payment_type'].'" name="payment_type">											
										<button class="btn waves-effect waves-light right submit" type="submit" name="action">Hủy đơn hàng
