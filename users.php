    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Menu</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Đơn đặt hàng</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">Tất cả</a>
                                </li>
								<?php
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Người dùng</a>
            </li>				
        </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Chỉnh sửa người dùng</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/user-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Danh sách người dùng</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Vai trò</th>
                        <th data-field="price">Xác minh</th>
                        <th data-field="price">Kích hoạt</th>
                        <th data-field="price">Ví</th>						
                      </tr>
                    </thead>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><select name="'.$row['id'].'_role">
                      ...
                      <option value="Khách hàng"'.($row['role']=='Khách hàng' ? 'selected' : '').'>Khách hàng</option>
                    </select></td>';
					...
					echo '<td><select name="'.$row['id'].'_deleted">
                      <option value="1"'.($row['deleted'] ? 'selected' : '').'>Vô hiệu hóa</option>
                      <option value="0"'.(!$row['deleted'] ? 'selected' : '').'>Kích hoạt</option>
                    </select></td>';
					$key = $row['id'];
					...
					echo '<td><label for="balance">Sô dư</label><input id="balance" name="'.$row['id'].'_balance" value="'.$balance.'" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Chỉnh sửa
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Thêm người dùng</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        <th data-field="name">Tài Khoản</th>
                        <th data-field="name">Mật khẩu</th>							
                        <th data-field="name">Họ tên</th>
                        <th data-field="price">Email</th>
                        <th data-field="price">Số điện thoại</th>
                        <th data-field="price">Địa chỉ</th>	
                    ...
                    <tbody>
				<?php
					echo '<tr><td><label for="username">Tài khoản</label><input id="username" name="username" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';   									
					echo '<td><label for="password">Mật khẩu</label><input id="password" name="password" type="password" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';   									
					echo '<td><label for="name">Họ Tên</label><input id="name" name="name" type="text" data-error=".errorTxt04"><div class="errorTxt04"></div></td>';
					echo '<td><label for="email">Email</label><input id="email" name="email" type="email"></td>';
					echo '<td><label for="contact">Số điện thoại</label><input id="contact" name="contact" type="number" data-error=".errorTxt05"><div class="errorTxt05"></div></td>';   
					echo '<td><label for="address">Địa chỉ</label><input id="address" name="address" type="text" data-error=".errorTxt06"><div class="errorTxt06"></div></td>';   
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Thêm
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
