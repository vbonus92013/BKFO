          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Chi tiết đặt món</h5>
              </div>
            </div>
          </div>
        </div>
...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title white-text darken-1">Phản hồi No. '.$ticket_id.'</span>
										...
										.($status != 'Closed' ? 'Đóng<i class="mdi-navigation-close"></i>' : 'Mở<i class="mdi-navigation-check"></i>').'
										</button>
										</form>
										</div>
									</div>										
								...
								while($row1 = mysqli_fetch_array($sql1)){
								  ...
								  <li class="collection-item avatar">
									  ...
									  <p><strong>Ngày:</strong> '.$row1['date'].'</p>
									  <p><strong>Vai trò:</strong> '.$role1.'</p>					                               
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message.php" novalidate="novalidate" class="col s12">					  
					  ...
					  <input type="hidden" name="ticket_id" value="'.$ticket_id.'">
                        <div class="input-field col s12">
                          ...
                          <label for="message" class="">Thêm phản hồi</label>
						  <div class="errorTxt1"></div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Phản hồi
